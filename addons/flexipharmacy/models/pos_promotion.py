...
class Pos_promotion(models.Model):
    ...
    _description = 'Used to Store Promotion Settings.'
...
class Conditions_data(models.Model):
    ...
    _description = 'Used to Store Promotion Rules Checklist.'
...
class quantity_discount(models.Model):
    ...
    _description = 'Used to Store Discount for Quantity.'
...
class quantity_discount_amt(models.Model):
    ...
    _description = 'Used to Store Quantity Discount Amount.'
...
class Get_product_discount(models.Model):
    _name = 'get.discount'
    _description = 'Used to Fatch Discount.'
...
class Discount_On_Multiple_Products(models.Model):
    ...
    _description = 'Used to Store Discount on Multiple Products.'
...
class Discount_On_Multiple_Categories(models.Model):
    ...
    _description = 'Used to Store Discount on Multiple Categories.'
...
class Discount_On_Above_Price(models.Model):
    ...
    _description = 'Used to Store Discount on Above Price.'
