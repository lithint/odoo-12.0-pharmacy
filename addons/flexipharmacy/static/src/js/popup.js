...
//	        $('#orderdate-datepicker').focus();
	    ...
	    renderElement: function(){
			...
			$('#requesteddate-datepicker').datetimepicker({format:'Y-m-d H:i'}).val(new moment ().locale('en').format("YYYY-MM-DD HH:mm"));
    ...
    var DeliveryDetailPopupWidget = PopupWidget.extend({
        ...
        show: function(options){
            ...
            $("#delivery_detail_date").focusout(function() {
		        ...
		        $('body').keydown(self.pos.chrome.screens.payment.keyboard_keydown_handler);
